...
class MultiAiRepairLoopTest {
    ...
    fun parsesPassReviewWithoutCandidate() {
        val parsed = MultiAiRepairLoop.parseReview(
            "STATUS: PASS ISSUES: Keine kritischen Fehler. TESTS: Kompiliert und Randfall geprueft. CANDIDATE: NONE",
        )
    ...
    fun parsesFixReviewWithCandidate() {
        val parsed = MultiAiRepairLoop.parseReview(
            "STATUS: FIX ISSUES: Nullfall fehlt. TESTS: Leere Eingabe und Timeout pruefen. " +
                "CANDIDATE: Eingabe validieren, Timeout behandeln und Tests ergaenzen.",
        )
    ...
    fun rejectsFixWithoutCandidate() {
        val parsed = MultiAiRepairLoop.parseReview(
            "STATUS: FIX ISSUES: Fehler vorhanden. TESTS: Test fehlt. CANDIDATE: NONE",
        )
